...
path_toplevel = os.path.join(os.sep, "projects", "sanlab", "shared", "bidsWorkshop") # folder that contains path_bidsdata and path_conversionfolder
...
singularity_image =  os.path.join(os.sep, "projects", "sanlab", "shared", "containers", "dcm2bids_2022-01-17.sif")
