...
singularity_image = "dcm2bids_2022-01-17.sif" # ignored if running locally; dcm2bids singularity image name
...
path_toplevel = os.path.join(os.sep, "projects","sanlab","bsmith16", "bids_workshop/") # folder that contains path_bidsdata and path_conversionfolder
...
path_bidsdata = os.path.join(os.sep, "projects", group, "bsmith16", "bids_workshop", "bids_data") # Where the niftis will be put
